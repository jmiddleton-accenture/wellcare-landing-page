...
//        VideoPlayerInterface.updatePreparedForName();
      ...
      console.log(array('x(un-) '+unauthorized + ' y ' + VideoPlayerInterface.RTCVisit.videoVisitData['authorized'] +' z '+VideoPlayerInterface.isPlaying + ' q ' + VideoPlayerInterface.currentState + ' d ' + Date.now() + ' s '));
    },
